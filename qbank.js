...
// ── SESSION CACHE KEY (unique per page load — bypasses CDN cache) ──────────────
...
async function fetchSubjectData(slug) {
  try {
    const res = await fetch(`https://raw.githubusercontent.com/vhaldkar66-web/medqbank/main/${slug}.json?v=${SESSION_V}`);
